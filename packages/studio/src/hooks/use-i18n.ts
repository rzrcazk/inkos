...
const strings = {
  ...
  "config.modelRoutingDesc": { zh: "为每个代理分配不同模型，按需平衡质量与成本。未配置的代理使用默认模型。", en: "Assign different models to each agent to balance quality and cost. Agents without overrides use the default model." },
  "config.defaultModel": { zh: "默认模型", en: "Default Model" },
  "config.overrideToggle": { zh: "覆盖", en: "Override" },
  "config.selectService": { zh: "选择服务...", en: "Select service..." },
  "config.selectModel": { zh: "选择模型...", en: "Select model..." },
  "config.advanced": { zh: "高级选项", en: "Advanced Options" },
  "config.streamToggle": { zh: "流式输出", en: "Stream Output" },
  "config.noOverrides": { zh: "暂无路由配置，所有代理使用默认模型。", en: "No routing configured. All agents use the default model." },
  "config.saved": { zh: "已保存", en: "Saved" },
  "config.saveError": { zh: "保存失败", en: "Save failed" },
  "config.agent.writer": { zh: "写手", en: "Writer" },
  "config.agent.auditor": { zh: "审计员", en: "Auditor" },
  ...
  "config.smartRoutingPanel": { zh: "智能路由推荐", en: "Smart Routing Recommendations" },
  "config.routingRules": { zh: "路由规则", en: "Routing Rules" },
  "config.tier.top": { zh: "顶级能力", en: "Top Tier" },
  "config.tier.top.desc": { zh: "Claude 模型 token 最少但能力最强，适合核心写作", en: "Claude models use fewest tokens but have best capability — for core writing" },
  "config.tier.high": { zh: "高量 Token", en: "High Token" },
  "config.tier.high.desc": { zh: "MiniMax 模型 token 最多，适合大规模审计和修订", en: "MiniMax models provide most tokens — for auditing and revision" },
  "config.tier.midhigh": { zh: "中高量", en: "Mid-High Token" },
  "config.tier.midhigh.desc": { zh: "Qwen/GLM/Kimi token 较多，性价比高", en: "Qwen/GLM/Kimi offer good token-to-quality ratio" },
  "config.tier.mid": { zh: "中量", en: "Mid Token" },
  "config.tier.mid.desc": { zh: "Gemini/GPT 适合轻量任务", en: "Gemini/GPT for lightweight tasks" },
  "config.applyRecommendations": { zh: "应用推荐", en: "Apply Recommendations" },
  "config.notYetAvailable": { zh: "暂未启用", en: "Not yet available" },
  "config.usingDefaultModel": { zh: "使用默认模型", en: "Using default model" },
  "config.reason.writer": { zh: "顶级能力，适合核心写作", en: "Best capability for core writing" },
  "config.reason.architect": { zh: "顶级推理，故事架构规划", en: "Top reasoning for story architecture" },
  "config.reason.auditor": { zh: "Token 充足，大规模文本审计", en: "Abundant tokens for large-scale text audit" },
  "config.reason.reviser": { zh: "Token 充足，上下文修订", en: "Abundant tokens for context revision" },
